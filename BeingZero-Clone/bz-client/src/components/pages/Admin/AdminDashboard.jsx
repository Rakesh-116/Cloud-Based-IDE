    ...
    <div className="bg-black/95 min-h-screen text-white">
      ...
      <div className="mt-28 px-10">
        <div className="flex items-center w-full space-x-4">
          <div className="mb-8 p-4 border border-white/40 rounded-lg w-[40%] h-[200px]">
          ...
          <div className="mb-8 p-4 border border-white/40 rounded-lg w-[60%] h-[200px]">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 border border-white/30 rounded-lg hover:bg-gray-700 transition-all"
            >
              ✍️ Write a Blog
            </button>
          </div>
